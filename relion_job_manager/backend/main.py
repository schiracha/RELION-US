"""
main.py — FastAPI backend for the RELION Job Manager web app.
...
Endpoints:
  ...
  POST /api/project/init                  -> mark a folder as a new RELION-
                                              job-manager project and switch
                                              to it
...
app = FastAPI(title="RELION Job Manager")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
